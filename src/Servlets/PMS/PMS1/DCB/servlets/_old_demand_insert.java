...
public class _old_demand_insert
		 {		
Connection con = null;
...
try 
{
	...
	System.out.println("select sum(amount) from fas_receipt_transaction where   sub_ledger_type_code = 10 "+ " " + main_cond + "" + cond2);
	if (rs_coll.next()) 
	{
...
+ " and BENEFICIARY_SNO ="+ ben+ "  and OFFICE_ID ="+ Office_id+ " and CR_DR_INDICATOR='DR' ";
...
ins_qry += "," + COLN_CUR_YR_WC + "," + COLN_MAINT+ "," + COLN_YESTER_YR_WC + ","+ CB_MAINT_CHARGES + "," + ""+ CB_CUR_YR_WC + "," + CB_YESTER_YR_WC+ ","+sch_OB_INT_AMT_WC+","+str_CB_INT_AMT_WC+","+COLN_INT_FOR_MTH_WC+")";
...
yearly_insert = "insert into PMS_DCB_OB_YEARLY ( "+ "BENEFICIARY_OB_SNO,BENEFICIARY_SNO,FIN_YEAR,MONTH,"
...
net_COLN_YESTER_YR_WC = 0;
					...
					*/
					...
					yearly_insert = "insert into PMS_DCB_OB_YEARLY ( BENEFICIARY_OB_SNO,BENEFICIARY_SNO,FIN_YEAR,MONTH,OFFICE_ID,SCH_SNO,AS_ON_DATE,"
								  + "OB_MAINT_CHARGES,OB_CUR_YR_WC,OB_YESTER_YR_WC,OB_INT_PRV_YR_MAINT,OB_INT_CUR_YR_MAINT,OB_INT_AMT_WC,DMD_UPTO_PRV_MTH_WC,"
								  + "DMD_INT_UPTO_PRV_MTH_WC,COLN_UPTO_PRV_MTH_MAINT,COLN_UPTO_PRV_MTH_YESTER_YR,COLN_UPTO_PRV_MTH_WCCOLN_INT_UPTO_PRV_MTH_MAINT,"
						+ "COLN_INT_UPTO_PRV_MTH_WC,"
	...
	*/
	up_qry = "update PMS_DCB_TRN_BILL_DMD set COLN_CUR_YR_WC="+net_COLN_CUR_YR_WC+",COLN_MAINT="+net_COLN_MAINT
			+",COLN_YESTER_YR_WC="+net_COLN_YESTER_YR_WC+",CB_MAINT_CHARGES="+net_CB_MAINT+",CB_CUR_YR_WC="+net_CB_CUR_YR_WC
			+",CB_YESTER_YR_WC="+net_CB_YESTER_YR_WC+",CB_INT_AMT_WC="+CB_INT_AMT_WC+"   where BILL_SNO="+maxsno;
